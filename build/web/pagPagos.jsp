...
<%@page import="modelo.Pagos,java.util.*" %>
<!DOCTYPE html>
<html>
    <head>
...
table {
  background-color: #ff33cc;
    ...
    <body style="background-color:#96d7f8;">
           <%
            List<Pagos> lista=(ArrayList)request.getAttribute("dato");
            String nom=(String)request.getAttribute("dato2");
         %>
         <h2 class="text-creado">Lista de Pagos de  <%=nom%></h2>
         ...
         <table class="table">
             <thead>
                 <tr class="bg-dark"><th>Semestre<th>Monto
             </thead>   
          <%
            double sm=0;
            for(Pagos x:lista){
